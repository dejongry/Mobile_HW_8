...
public class WeatherService extends IntentService {
    ...
    private static final String apiKey = "66b47852d65d2a8989708428de0a9eb4";
    ...
    private void fetchWeatherData(String key, String lat, String lon) {
        try {
            ...
            URL url = new URL(BASE_URL + "lat=" + lat + "&lon=" + lon + "&appid=" + apiKey);
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                ...
                String current = weatherObj.getString("description");
                ...
                result.putExtra("SUMMARY", current);
